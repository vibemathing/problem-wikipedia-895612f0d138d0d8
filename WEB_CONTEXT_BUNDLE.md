...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:wikipedia-895612f0d138d0d8",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-895612f0d138d0d8",
    ...
    "statement": {
      "language": "en",
      "text": "Jacobian conjecture for two-dimensional spaces: if a two-dimensional polynomial mapping over a characteristic -0 field has a constant nonzero Jacobian determinant , then does it have a regular (i.e. with polynomial components) inverse function?",
      "version": 1
    },
    "title": "Jacobian conjecture",
    "updated_at": "2026-09-08T11:09:27Z"
  },
  "problem_contract_sha256": "eb61f311034fb101fe2f9d3c91f30c58ffa5b0347437ed6ac66e483898964a8f"
}
```
